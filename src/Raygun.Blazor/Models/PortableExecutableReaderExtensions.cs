...
internal static class PortableExecutableReaderExtensions
{
    ...
    public static bool TryGetDebugInformation(this PEReader? peReader, out PEDebugDetails? debugInformation)
    {
        if (peReader is null)
        {
    ...
    private static PEDebugDetails GetDebugInformation(this PEReader peReader)
    {
        var debugInfo = new PEDebugDetails
        {
